...
export default function Mens() {
  ...
  useEffect(() => {
    const fetchProducts = async () => {
      try {
        const query = `*[_type == "product" && category in ["Men's Training Shoes", "Women's Basketball Jersey"]]{ _id, productName, category, price, inventory, colors, status, "imageUrl": image.asset->url, description }` ;
