...
export default function Mens() {
  ...
  useEffect(() => {
    const fetchProducts = async () => {
      try {
        const query = `*[_type == "product" && category in ["Men's Shoes", "Women's Shoes", "Men's Running Shoes"]]{ _id, productName, category, price, inventory, colors, status, "imageUrl": image.asset->url, description }` ;
