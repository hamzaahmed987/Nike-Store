...
export default function Header() {
    ...
    <>
      <header className="body-font bg-[#F5F5F5] h-[36px] pt-1">
        <div className="container mx-auto flex flex-wrap items-center justify-between px-6">
          ...
          {/* Navigation Section */}
          <nav className="flex flex-wrap items-center mt-1 text-sm text-[#111111] font-helvetica space-x-2 md:space-x-6 ">
      ...
      <nav className="hidden md:flex ml-44 space-x-8 text-[15px]">
  ...
  <div className="flex items-center gap-[10px] px-[15px] py-[5px] border border-gray-300 rounded-2xl">
    ...
    <Image src={"/search.svg"} alt={"Search"} width={20} height={20} className={"w-[20px] h-[20px]"}/>
  </div>
